...
namespace AIFramework
{
    ...
    public static class AIModifiers
    {
        ...
        public const float hungerHitpointsDamagePerSecond = 4.0f;
        public const float hitpointRegenPerSecond = 1.0f;
        public const float hungerReductionPerFeeding = 20.0f;
        public const float hungerReductionPerKill = 25.0f;
        public const float procreationHungerIncrease = 30.0f;
